...
<div class="content">
   <div class="jumbotron  col-6 mx-auto " style="background-color: rgb(58, 59, 61);margin-top:12%"">
        <div class="container"  >
               ...
               <form action="#" onsubmit="return checkRequest()">
            	...
            	<div class="form-group ">
                    ...
                    <input id="datefield" type='date' min='1899-01-01' max='2000-13-13' class="form-control"   name="date" required>
